            ...
            <div class="mb-6 transform hover:scale-105 transition duration-300">
                <a href="/" class="flex flex-col items-center gap-2 group">
                    <div class="p-4 rounded-3xl bg-slate-950/80 border border-amber-500/30 shadow-[0_0_30px_rgba(245,158,11,0.25)] ring-1 ring-amber-400/20">
                        <x-application-logo class="w-16 h-16 fill-current text-amber-400 drop-shadow-[0_0_10px_rgba(251,191,36,0.6)]" />
                    </div>
                    <span class="text-xs uppercase tracking-[0.3em] font-extrabold text-amber-400/90 group-hover:text-yellow-300 transition">Casino VIP</span>
                </a>
            </div>
